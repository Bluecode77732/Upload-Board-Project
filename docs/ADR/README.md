...
| [0056](0056-networkpolicy-east-west-restriction.md) | NetworkPolicy for cluster east-west traffic restriction — egress-primary, gated off by default, extends 0041 | Accepted — implemented, kind+Calico-verified; 2026-09-26 addendum: decided to turn the AWS agent on, code and live checks are follow-up | 2026-09-11 |
