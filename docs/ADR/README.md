...
| [0050](0050-consent-based-file-ownership-transfer.md) | Consent-based file ownership transfer — propose/accept/reject/cancel, replaces the unconsented `userId` field, amends 0024 | Accepted | 2026-09-04 |
