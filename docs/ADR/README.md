...
| [0059](0059-upload-malware-scanning-clamav.md) | Malware scanning for uploads — synchronous ClamAV gate before temp write | Accepted — implemented, live+CI-verified (Helm install unverified) | 2026-09-14 |
