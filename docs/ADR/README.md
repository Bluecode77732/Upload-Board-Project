...
| [0044](0044-terraform-three-state-split.md) | Terraform three-state split — cluster/addons/app-infra lifecycle separation, amends 0043 | Accepted (design-only) | 2026-08-19 |
