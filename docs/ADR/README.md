...
| [0062](0062-admin-same-alb-subpath-routing.md) | Admin console hosting — a third workload on the same ALB, at `/admin`, extends 0060/0058 | Accepted — implemented, helm-template/lint + local image + Docker Desktop `helm install --wait` verified (live ALB unverified) | 2026-09-23 |
