...
| [0061](0061-shutdown-hooks-and-pid1-sigterm.md) | Graceful shutdown — `enableShutdownHooks()` and node as PID 1 ignoring SIGTERM, extends 0030 | Accepted — implemented, container-verified (not on Kubernetes) | 2026-09-21 |
