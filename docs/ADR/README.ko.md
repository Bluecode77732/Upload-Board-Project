...
| [0062](0062-admin-same-alb-subpath-routing.ko.md) | admin 콘솔 호스팅 — 같은 ALB의 세 번째 워크로드, `/admin` 서브패스, 0060·0058 확장 | 승인됨 — 구현 완료, helm template/lint·로컬 이미지·Docker Desktop `helm install --wait` 검증 (라이브 ALB 미검증) | 2026-09-23 |
